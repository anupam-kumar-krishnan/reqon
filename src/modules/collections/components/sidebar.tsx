        ...
        return (
          <div className="h-full bg-zinc-950 text-zinc-100 flex flex-col">
            <div className="flex items-center justify-between p-4 border-b border-zinc-800">
              ...
              <div className="flex items-center space-x-2">
                <HelpCircle className="w-4 h-4 text-zinc-400 hover:text-indigo-400 cursor-pointer" />
                <ExternalLink className="w-4 h-4 text-zinc-400 hover:text-indigo-400 cursor-pointer" />
              </div>
            </div>
            ...
            <div className="p-4 border-b border-zinc-800">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search"
                  className="w-full bg-zinc-900 border-zinc-700 rounded-lg pl-10 pr-4 py-2 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
              </div>
            </div>
            <div className="p-4 border-b border-zinc-800">
            ...
            {collections && collections.length > 0 ? (
              collections.map((collection) => (
                <div
                  className="flex flex-col justify-start item-start p-3 border-b border-zinc-800 w-full"
                  key={collection.id}
                >
